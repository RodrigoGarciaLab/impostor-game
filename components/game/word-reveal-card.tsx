    ...
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="perspective-1000">
        ...
        >
          ...
          >
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-stone-900 via-stone-950 to-black border-2 border-stone-800/50 shadow-2xl">
          ...
          <div
            className={cn(
              "backface-hidden rotate-y-180 transition-opacity duration-300",
          ...
          >
            <div
              className={cn(
                'relative overflow-hidden rounded-3xl border-2 shadow-2xl min-h-[400px]',
                isImpostor
